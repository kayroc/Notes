...
| &lt;head&gt;&lt;/head&gt; | 文档的头部 | 注意在 head 标签中必须要设置的标签是 title |
| &lt;title&gt;&lt;/title&gt; | 文档的标题 | 让页面拥有一个属于自己的网页标题 |
| &lt;body&gt;&lt;/body&gt; | 文档的主体 | 元素包含文档的所有内容，页面内容 基本都是放在 body 里面 |

![](/img/html/HTML%20基本结构.jpg)

<font color="#C3463A">HTML 文件的后缀名必须是 .html 或 .htm</font>，浏览器的作用是读取 HTML 文档，并以网页的形式显示出它们。
